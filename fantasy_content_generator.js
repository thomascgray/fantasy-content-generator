...
module.exports=[
    ...
    "A magical floating {bush/flower/plant/rose}. It hovers around in circles.",
    ...
    "A rotting, moss covered bookshelf in a clearing. Its decrepit shelves are filled with molding tomes in various states of decay. What is still legible in the books is a variety of languages and dialects, some unknown.",
...
},{"./loots":6,"./names":7,"./npcs":10,"./settlements":11,"./storyhooks":12}],5:[function(require,module,exports){
require('../src/data/names.json');require('../src/data/points_of_interest.json');require('../src/data/settlements.json');require('../src/npcs/characterTraits.json');require('../src/npcs/flaws.json');require('../src/storyhooks/npc_acts.json');require('../src/storyhooks/pc_related.json');

window.FantasyContentGenerator = require('./index')
},{"../src/data/names.json":1,"../src/data/points_of_interest.json":2,"../src/data/settlements.json":3,"../src/npcs/characterTraits.json":8,"../src/npcs/flaws.json":9,"../src/storyhooks/npc_acts.json":13,"../src/storyhooks/pc_related.json":14,"./index":4}],6:[function(require,module,exports){
...
},{"../data/names.json":1,"../utils":15}],8:[function(require,module,exports){
module.exports=[
    "Chews tobacco",
    "Smokes",
    "Allergic to {food/dust/pollen/animals}",
    "Always arrives {late/early}",
...
module.exports = functions
},{"../data/names.json":1,"../names":7,"../utils":15,"./characterTraits.json":8,"./flaws.json":9}],11:[function(require,module,exports){
const Utils = require('../utils');
...
module.exports = functions
},{"../data/points_of_interest.json":2,"../data/settlements.json":3,"../utils":15}],12:[function(require,module,exports){
const Utils = require('../utils');
